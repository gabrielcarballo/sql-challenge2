...
CREATE TABLE SpotifyClone.`artistas`(
  ...
  CREATE TABLE SpotifyClone.artistas_seguidos(
      ...
      artista_seguido INT,
      PRIMARY KEY (usuario_seguindo, artista_seguido),
  ...
  VALUES
    ...
    INSERT INTO SpotifyClone.usuario (usuario_nome, idade, data_assinatura, plano_id)
        VALUES
    ...
    INSERT INTO SpotifyClone.artistas_seguidos (usuario_seguindo, artista_seguido)
        VALUES
            (1, 1),
            (1, 2),
            (1, 3),
            ...
            INSERT INTO SpotifyClone.cancoes (cancao_nome, duracao_segundos, ano_lancamento, album_id)
        VALUES
            ...
            INSERT INTO SpotifyClone.historico (usuario_id, historico_reproducao, data_reproducao)
        VALUES
